...
class XMLParser ( Parser ):
    ...
    ruleNames =  [ "optionmenu", "prolog", "content", "element", "reference", 
    ...
    class OptionmenuContext(ParserRuleContext):
        __slots__ = 'parser'
        ...
        def getRuleIndex(self):
            return XMLParser.RULE_optionmenu

        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterOptionmenu" ):
                listener.enterOptionmenu(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitOptionmenu" ):
                listener.exitOptionmenu(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitOptionmenu" ):
                return visitor.visitOptionmenu(self)
            else:
    ...
    def optionmenu(self):
        ...
        localctx = XMLParser.OptionmenuContext(self, self._ctx, self.state)
        self.enterRule(localctx, 0, self.RULE_optionmenu)
