...
class XMLParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by XMLParser#optionmenu.
    def enterOptionmenu(self, ctx:XMLParser.OptionmenuContext):
        pass

    # Exit a parse tree produced by XMLParser#optionmenu.
    def exitOptionmenu(self, ctx:XMLParser.OptionmenuContext):
        pass
