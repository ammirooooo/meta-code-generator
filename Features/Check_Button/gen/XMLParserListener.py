...
class XMLParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by XMLParser#checkButton.
    def enterCheckButton(self, ctx:XMLParser.CheckButtonContext):
        pass

    # Exit a parse tree produced by XMLParser#checkButton.
    def exitCheckButton(self, ctx:XMLParser.CheckButtonContext):
        pass
